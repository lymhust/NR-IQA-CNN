...
prototxt_url = 'http://git.io/vIdRW/nin_imagenet_deploy.prototxt'
model_url = 'https://www.dropbox.com/s/0cidxafrb2wuwxw/nin_imagenet.caffemodel'
img_mean_url = 'https://www.dropbox.com/s/p33rheie3xjx6eu/ilsvrc_2012_mean.t7'
...
prob, classes = net:forward(I:cuda()):view(-1):float():sort(true)
